...
url = 'http://192.168.87.26:8080/video'
...
while True:
    ...
    if hands:
        ...
        if imgCrop.shape[0] > 0 and imgCrop.shape[1] > 0:  # Check if imgCrop has valid dimensions
            ...
            cv2.rectangle(imgCrop, (x_offset, y_offset), (x_offset + new_width, y_offset + new_height), (275, 200, 0), 4)

            # Put the label inside the rectangle
            cv2.putText(imgCrop, labels[index], (x_offset + 10, y_offset + 30), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2)
